...
});};var f={};h.Loader.loadModule=function(i,j){if(min){i=i.replace(/^(?:Briage\.)?(.*?)(?:\.min)?(?:\.js)?$/,"Briage.$1.min.js");}else{i=i.replace(/^(?:Briage\.)?(.*?)(?:\.min)?(?:\.js)?$/,"Briage.$1.js");
...
k=arguments[j-1];}else{i=arguments;k=null;}}h.Loader.loadModules(i,function(){if(k){k(h.deepclone(h,true));}});},add:function(l,j,i,k){if(min){j=j.replace(/^(?:Briage\.)?(.*?)(?:\.min)?(?:\.js)?$/,"Briage.$1.min.js");
