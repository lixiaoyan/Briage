...
},i);}}else{k=j;}return k;};h.Class=function(l,i){l=l||function(){};i=i||{};var m;var k=[];if(i.extend){if(h.toString.call(i.extend)=="[object Object]"){if(i.extend.prototype||i.extend.constructor){if(i.extend.constructor){m=function(){i.extend.constructor.apply(this,arguments);
var n=l.apply(this,arguments);if(n){return n;}};h.extend(m,i.extend.constructor,true,true);k.push(i.extend.constructor);}else{m=function(){var n=l.apply(this,arguments);
if(n){return n;}};}if(i.extend.prototype){if(h.toString.call(i.extend.prototype)=="[object Object]"){var j=function(){};j.prototype=i.extend.prototype;
m.prototype=new j();}else{m.prototype=new i.extend.prototype();}k.push(i.extend.prototype);}}else{m=function(){var n=l.apply(this,arguments);if(n){return n;
}};}}else{m=function(){i.extend.apply(this,arguments);var n=l.apply(this,arguments);if(n){return n;}};h.extend(m,i.extend,true,true);m.prototype=new i.extend();
k.push(i.extend);}}else{m=function(){var n=l.apply(this,arguments);if(n!==undefined){return n;}};}m.prototype.constructor=m;if(i.method){h.extend(m,i.method,true,true);
}if(i.prototype){h.extend(m.prototype,i.prototype,true,true);}m.superClass=k;m.prototype.callSuper=function(p){var n=this;var o=Array.prototype.slice.call(arguments,1);
h.each(m.superClass,function(r,q){if(q.prototype[p]){q.prototype[p].apply(n,o);}});};return m;};h.namespace=function(j,k){j=j.replace(/^B\./,"");var l=j.split(".");
var i=this;h.each(l,function(){if(!i[this]){i[this]={};}i=i[this];});if(k){k.call(i);}};h.param=function(j){if(typeof j=="string"){return j;}var i=[];h.each(j,function(k,l){i.push(encodeURIComponent(k)+"="+encodeURIComponent(l));
});return i.join("&");};h.ajax=function(i){i=h.extend({type:"GET",url:c.location.href,data:{},contentType:"application/x-www-form-urlencoded",async:true,success:function(){},error:function(){}},i,true,true);
